      ...
      <div className="h-screen bg-white">
        <div className="container mx-auto">
          ...
          <div className='my-8 mx-auto grid md:grid-cols-3 sm:grid-cols-1 gap-5'>
            <div className='rounded-xl bg-slate-50 py-6 px-3'>
              <h2 className="text-sm font-light tracking-widest leading-8 text-neutral-500 font-['Prompt']">IN PROGRESS</h2>
              <h2 className="text-2xl font-medium tracking-widest leading-8 text-neutral-900 font-['Prompt']">AMSA WEBSITE TEAM</h2>
              <p className="mt-1 font-bold tracking-wide text-neutral-400 text-xl text">Working with amsa website team as backend developer</p>
            </div>
          </div>
        </div>
      </div>
